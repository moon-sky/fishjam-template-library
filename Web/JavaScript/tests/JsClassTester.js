...
//TODO: JavaScript编程的最佳实践 ?

/*************************************************************************************************************************
* TODO(没有测试确认) -- JavaScript实现经典的类，总结有三种方法:
*  1.构造函数方式 -- 构造函数用来初始化实例对象的属性和值。任何JavaScript函数都可以用作构造函数，构造函数必须使用new运算符作为前缀来创建新的实例。
*      方式简单，但是浪费内存(每个实例有自己的代码空间)
*  2.原型方式
*  3.构造函数+原型的混合方式
*************************************************************************************************************************/

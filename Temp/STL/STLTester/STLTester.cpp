// STLTester.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CSTLTesterApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSTLTesterApp construction

CSTLTesterApp::CSTLTesterApp()
{
    //TRACE(TEXT("%d:%d\n"), MYVALUE1, MYVALUE2);
}


// The one and only CSTLTesterApp object

CSTLTesterApp theApp;


// CSTLTesterApp initialization

BOOL CSTLTesterApp::InitInstance()
{
    ...
    SetRegistryKey(TEXT("STL Tester"));

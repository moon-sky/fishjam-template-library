...
/******************************************************************************************************************
* 安装 -- 32位版的驱动安装为缺省安装选项，发现是64位系统时调用CreateProcess函数来启动64位的安装进程
*   UpdateDriverForPlugAndPlayDevices -- 如返回 ERROR_IN_WOW64 说明在64位系统上
******************************************************************************************************************/
...
/******************************************************************************************************************
* 64-Bit INF 文件要求 -- Inf文件中必须含有 NTx86/NTAmd64/NTIA64 之类的修饰符才行
******************************************************************************************************************/

...
*     Vista(管理员权限修改BCD -- Boot Configuration Data) -- copy一个新的配置后通过GUI配置方式配置(msconfig -> Boot -> Advanced options)：
...
*       bcdedit /set loadoptions {Debug配置项的GUID} DDISABLE_INTEGRITY_CHECKS  <== 关闭 Win7 系统中的驱动签名强制要求

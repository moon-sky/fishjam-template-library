...
<body>
	...
	<s:debug></s:debug>
	.
	<s:form  action="/editFloor" id="targetForm">
		<div>
			<table cellpadding="1" cellspacing="1" width="100%">
				<tr>
					<td colspan="3">商场地图列表</td>
				</tr>
				<tr>
					<td>选中</td>
					<td>索引</td>
				...
				<s:iterator id="storemap" value="storeMaps" status="st">
					<tr>
						<td><input type="radio" name="mapId"
		...
		<input type="submit" value="编辑"  onclick="targetForm.action='editFloor!edit'">

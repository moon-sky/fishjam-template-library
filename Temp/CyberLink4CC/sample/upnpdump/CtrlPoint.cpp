...
void CtrlPoint::eventNotifyReceived(const std::string &uuid, long seq, const std::string &varName, const std::string &value)
{
	cout << "event notify : uuid = " << uuid << ", seq = " << seq << ", name = " << varName << ", value =" << value << endl; 
}

...
#pragma warning ( default: 4244 )
    ...
    *           $PROGRAMFILES, $COMMONFILES, $DESKTOP(当前用户桌面), $STARTMENU(开始菜单目录), $SMPROGRAMS(开始菜单里的Programs目录),
    ...
    *         !insertmacro MUI_LANGUAGE "语言(如English) <== 需要对应的资源文件(如 Contrib\Language files\English.nsh)
    *         

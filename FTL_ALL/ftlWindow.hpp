...
#ifdef ENABLE_DUMP_TOOLTIP_MESSAGE
                //TODO: TTM_ACTIVATE 似乎和某个其他消息冲突了
                //GET_MESSAGE_INFO_ENTRY(TTM_ACTIVATE, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETDELAYTIME, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_ADDTOOLA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_ADDTOOLW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_DELTOOLA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_DELTOOLW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_NEWTOOLRECTA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_NEWTOOLRECTW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_RELAYEVENT, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETTOOLINFOA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETTOOLINFOW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETTOOLINFOA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETTOOLINFOW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_HITTESTA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_HITTESTW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETTEXTA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETTEXTW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_UPDATETIPTEXTA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_UPDATETIPTEXTW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETTOOLCOUNT, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_ENUMTOOLSA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_ENUMTOOLSW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETCURRENTTOOLA, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETCURRENTTOOLW, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_WINDOWFROMPOINT, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_TRACKACTIVATE, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_TRACKPOSITION, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETTIPBKCOLOR, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETTIPTEXTCOLOR, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETDELAYTIME, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETTIPBKCOLOR, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETTIPTEXTCOLOR, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETMAXTIPWIDTH, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETMAXTIPWIDTH, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETMARGIN, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETMARGIN, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_POP, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_UPDATE, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_GETBUBBLESIZE, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_ADJUSTRECT, CFDefaultMsgInfo);
                GET_MESSAGE_INFO_ENTRY(TTM_SETTITLEA, CFDefaultMsgInfo);

...
GUID_STRING_ENTRY g_OtherGuidNames[] = {
	...
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_RGB1,		//2色，每个像素用1位表示，需要调色板
		0xe436eb78, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70)
	// e436eb79-524f-11ce-9f53-0020af0ba770            MEDIASUBTYPE_RGB4 
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_RGB4,		//16色，每个像素用4位表示，需要调色板
		0xe436eb79, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70)
	// e436eb7a-524f-11ce-9f53-0020af0ba770            MEDIASUBTYPE_RGB8 
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_RGB8,		//256色，每个像素用8位表示，需要调色板
		0xe436eb7a, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70)
	// e436eb7b-524f-11ce-9f53-0020af0ba770            MEDIASUBTYPE_RGB565 
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_RGB565,	//每个像素用16位表示，RGB分量分别使用5位、6位、5位
		0xe436eb7b, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70)
	// e436eb7c-524f-11ce-9f53-0020af0ba770            MEDIASUBTYPE_RGB555 
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_RGB555,	//每个像素用16位表示，RGB分量都使用5位（剩下的1位不用）
		0xe436eb7c, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70)
	// e436eb7d-524f-11ce-9f53-0020af0ba770            MEDIASUBTYPE_RGB24 
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_RGB24,	//每个像素用24位表示，RGB分量各使用8位
		0xe436eb7d, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70)
	// e436eb7e-524f-11ce-9f53-0020af0ba770            MEDIASUBTYPE_RGB32 
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_RGB32,	//每个像素用32位表示，RGB分量各使用8位（剩下的8位不用）
	...
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_YUY2,		//YUY2格式，以4:2:2方式打包
	...
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_UYVY,		//UYVY格式，以4:2:2方式打包
		0x59565955, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71)
	// 55595659-0000-0010-8000-00AA00389B71  'YVYU' == MEDIASUBTYPE_YVYU 
	OUR_GUID_ENTRY(WMMEDIASUBTYPE_YVYU,		//YVYU格式，以4:2:2方式打包

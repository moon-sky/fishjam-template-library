...
*   IResourceManager
*   IServiceProvider
*   IVideoFrameStep	-- 可以控制graph向前指定帧
*   IVideoWindow -- 
...
*     如想使用，可以考虑从 qedit.h 文件中拷贝出其声明并使用
...
*   3.EVR 的 IMFVideoDisplayControl::SetFullscreen 可以设置全屏(但MSDN中写明最好不要用该函数)
*
* 显示第一帧
*   1.IVideoFrameStep::Step(1, NULL); //打开文件以后跳到第一帧
*   2.处理 EC_STEP_COMPLETE 事件，然后强制重绘一次
****************************************************************************************************/

================================================================================
    MICROSOFT 基础类库： StorageFile 项目概述
===============================================================================

应用程序向导已为您创建了此 StorageFile 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 StorageFile 应用程序的每个文件的内容摘要。
...
StorageFile.h
    ...
    CStorageFileApp 应用程序类。

StorageFile.cpp
    这是包含应用程序
    类 CStorageFileApp 的主应用程序源文件。
...
res\Toolbar.bmp
    ...
    更新 StorageFile.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

StorageFileDoc.h、StorageFileDoc.cpp - 文档
    这些文件包含 CStorageFileDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CStorageFileDoc::Serialize）。
    此文档将具有下列字符串：
        文件扩展名：      sdf
        文件类型 ID：        StorageFile.Document
        主框架标题：  Storage File Viewer
        文档类型名称：       StorageFile
        筛选器名称：         Storage Files (*.sdf)
        文件的新简称： StorageFile
        文件类型全称： StorageFile.Document
StorageFileView.h、StorageFileView.cpp - 文档视图
    这些文件包含 CStorageFileView 类。
    CStorageFileView 对象用于查看 CStorageFileDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 StorageFile.pch 的预编译头文件 (PCH)
